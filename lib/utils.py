...
def convertToRelativeValues(size: Tuple[float, float], box: Tuple[float, float, float, float]) -> \
...
def convertToAbsoluteValues(size: Tuple[float, float], box: Tuple[float, float, float, float]) -> \
        Tuple[float, float, float, float]:
